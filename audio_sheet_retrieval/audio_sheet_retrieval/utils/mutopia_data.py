...
from config.settings import DATA_ROOT_MSMD
from utils.data_pools import prepare_piece_data, AudioScoreRetrievalPool, AUGMENT, NO_AUGMENT
from utils.data_pools import SPEC_CONTEXT, SHEET_CONTEXT, SYSTEM_HEIGHT
...
if __name__ == "__main__":
    ...
    def train_batch_iterator(batch_size=1):
        ...
        from utils.batch_iterators import MultiviewPoolIteratorUnsupervised
        batch_iterator = MultiviewPoolIteratorUnsupervised(batch_size=batch_size, prepare=None, k_samples=None)
        return batch_iterator

    data = load_audio_score_retrieval(split_file="/Users/abdelrahman/Desktop/Tester1/audio_sheet_retrieval/audio_sheet_retrieval/msmd/splits/all_split.yaml ",
                                      config_file="/Users/abdelrahman/Desktop/Tester1/audio_sheet_retrieval/audio_sheet_retrieval/exp_configs/mutopia_no_aug.yaml",
                                      test_only=True)
    ...
    import time
#comment that epochs have been changed from 1000 to 10
