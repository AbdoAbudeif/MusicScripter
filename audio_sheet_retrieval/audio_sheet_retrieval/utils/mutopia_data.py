...
if __name__ == "__main__":
    ...
    data = load_audio_score_retrieval(split_file="/content/MusicScripter/audio_sheet_retrieval/audio_sheet_retrieval/msmd/splits/all_split.yaml",,
                                      config_file="/content/MusicScripter/audio_sheet_retrieval/audio_sheet_retrieval/exp_configs/mutopia_no_aug.yaml",
                                      test_only=True)
