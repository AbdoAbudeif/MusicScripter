...
from utils.monitoring import print_architecture
from models.lasagne_extensions.layers.cca import LengthNormLayer, LearnedCCALayer
...
from utils.mutopia_data import SPEC_CONTEXT

#EXP_NAME = 'Experiment-1'
INI_LEARNING_RATE = numpy.float32(0.002)
REFINEMENT_STEPS = 10
LR_MULTIPLIER = 0.5
BATCH_SIZE = 100
MOMENTUM = 0.9
#max epochs changed from 1000 to 2
MAX_EPOCHS = 1000
PATIENCE = 15
...
def objectives():
    """ Compile objectives """
    from models.objectives import get_contrastive_cos_loss
